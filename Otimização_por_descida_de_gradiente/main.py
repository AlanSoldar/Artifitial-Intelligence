...
if __name__ == '__main__':
    ...
    theta_0, theta_1, cost_graph, theta_0_progress, theta_1_progress = gradiente.gradient_descent(data, starting_theta_0=0, starting_theta_1=0, learning_rate=0.5, num_iterations=1000)
    
    print(gradiente.compute_cost(0, 0, data))
    print(gradiente.compute_cost(theta_0, theta_1, data))
    plt.figure(figsize=(10, 6))
    plt.scatter(areaList, priceList)
    pred0 = [0 * item + 0 for item in areaList]
